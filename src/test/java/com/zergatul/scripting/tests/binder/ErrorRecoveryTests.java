...
public class ErrorRecoveryTests extends BinderTestBase {
    ...
    public void invalidMethodCallTest() {
        ...
        comparator.assertEquals(Lists.of(
                ...
                Lists.from(result.diagnostics().stream().skip(result.diagnostics().size() - 1L).limit(1)));
    }
...
//                                                                        new BoundInvalidExpressionNode(Lists.of(), new SingleLineTextRange(2, 11, 23, 2)),
...
//                                new MultiLineTextRange(1, 1, 3, 2, 0, 27)),
//                        new BoundStatementsListNode(Lists.of(), Lists.of(), new SingleLineTextRange(3, 2, 27, 0)),
//                        new MultiLineTextRange(1, 1, 3, 2, 0, 27)),
//                result.unit());
    }
...
//        comparator.assertEquals(
//                new BoundCompilationUnitNode(
//                        new BoundCompilationUnitMembersListNode(Lists.of(), new SingleLineTextRange(1, 1, 0, 0)),
...
//                                                                BoundSeparatedList.of(Lists.of(
...
//                                                                        Lists.of(new BoundParameterNode(
//                                                                                new BoundNameExpressionNode(
