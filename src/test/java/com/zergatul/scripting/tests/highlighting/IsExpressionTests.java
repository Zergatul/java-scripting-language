...
public class IsExpressionTests extends ComparatorTest {
    ...
    public void constantPatternTest() {
        ...
        comparator.assertSemanticEquals(
                Lists.of(
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.OPERATOR_LIKE), new SingleLineTextRange(2, 7, 13, 2)),
    ...
    public void notPatternTest() {
        ...
        comparator.assertSemanticEquals(
                Lists.of(
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.PREDEFINED_TYPE), new SingleLineTextRange(1, 1, 0, 6)),
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.OPERATOR_LIKE), new SingleLineTextRange(2, 9, 20, 2)),
    ...
    public void declarationPatternTest() {
        ...
        comparator.assertSemanticEquals(
                Lists.of(
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.OPERATOR_LIKE), new SingleLineTextRange(2, 7, 16, 2)),
                        new SemanticToken(SemanticTokenType.KEYWORD, new SingleLineTextRange(2, 10, 19, 3)),
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.PREDEFINED_TYPE), new SingleLineTextRange(2, 14, 23, 6)),
