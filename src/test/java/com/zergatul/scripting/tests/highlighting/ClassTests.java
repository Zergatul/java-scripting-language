    ...
    public void visibilityModifiersTest() {
        ...
        comparator.assertSemanticEquals(
                Lists.of(
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.PREDEFINED_TYPE), new SingleLineTextRange(2, 12, 25, 3)),
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.PREDEFINED_TYPE), new SingleLineTextRange(4, 13, 79, 4)),
    ...
    public void binaryOperatorTest() {
        ...
        comparator.assertSemanticEquals(
                Lists.of(
                        ...
                        new SemanticToken(SemanticTokenType.KEYWORD, Lists.of(SemanticTokenModifier.OPERATOR_LIKE), new SingleLineTextRange(3, 16, 87, 3)),
