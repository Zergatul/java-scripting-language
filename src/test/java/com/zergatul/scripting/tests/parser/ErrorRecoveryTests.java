...
//                                                new SingleLineTextRange(2, 15, 24, 2)),
...
//                                                new SingleLineTextRange(1, 5, 4, 5)), new Token(TokenType.RIGHT_PARENTHESES, new SingleLineTextRange(1, 10, 9, 1))
...
//                                                new Token(TokenType.RIGHT_CURLY_BRACKET, new SingleLineTextRange(1, 24, 23, 0)),
...
//                                        new SingleLineTextRange(1, 1, 0, 25))), new SingleLineTextRange(1, 1, 0, 25)),
...
//                                                        new SingleLineTextRange(2, 15, 16, 2)),
...
//                                                        new SingleLineTextRange(2, 15, 18, 2)),
...
//                                        new InvalidExpressionNode(new SingleLineTextRange(2, 1, 3, 0)), new Token(TokenType.RIGHT_PARENTHESES, new SingleLineTextRange(2, 1, 3, 0)),
...
//                                                        new SingleLineTextRange(2, 15, 17, 2)),
...
//                                                        new SingleLineTextRange(2, 15, 22, 2)),
...
//                                                        new SingleLineTextRange(2, 15, 20, 2)),
...
//                                                                new SingleLineTextRange(2, 15, 23, 2)),
...
//                                                                .withTrailingTrivia(new Trivia(TokenType.LINE_BREAK, new SingleLineTextRange(1, 17, 16, 1))),
