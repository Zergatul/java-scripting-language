...
public class BoundPropertyAccessExpressionNode extends BoundExpressionNode {
    ...
    public BoundPropertyAccessExpressionNode update(BoundExpressionNode callee) {
        if (this.callee != callee) {
            return new BoundPropertyAccessExpressionNode(callee, property, getRange());
        } else {
            return this;
        }
    }
