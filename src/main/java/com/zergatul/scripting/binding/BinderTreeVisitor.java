...
public abstract class BinderTreeVisitor {
    ...
    public void explicitVisit(BoundBaseMethodInvocationExpressionNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(BoundFunctionDeclarationNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(BoundObjectInvocationExpression node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(BoundThrowExpressionNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(BoundThrowStatementNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void visit(BoundBaseMethodInvocationExpressionNode node) {}
    ...
    public void visit(BoundObjectInvocationExpression node) {}
    ...
    public void visit(BoundThrowExpressionNode node) {}
    public void visit(BoundThrowStatementNode node) {}
