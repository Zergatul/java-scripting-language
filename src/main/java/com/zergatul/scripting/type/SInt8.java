...
public class SInt8 extends SValueType {

    public static final SInt8 instance = new SInt8();

    private final SBoxedType boxed = new SBoxedType(this, Byte.class);
    ...
    private List<CastOperation> getImplicitCastsInternal() {
        return extendWithBoxing(
                ...
                INT8_TO_INT32.value(),
                INT8_TO_INT64.value(),
                INT8_TO_FLOAT32.value(),
                INT8_TO_FLOAT64.value(),
                INT8_TO_BOXED.value());
    }
    ...
    public List<MethodReference> getDeclaredMethods() {
        return Lists.of(METHOD_TO_STRING.value(), METHOD_TRY_PARSE.value());
    }
    ...
    private static final Lazy<CastOperation> INT8_TO_FLOAT32 = new Lazy<>(() -> new CastOperation(instance, SFloat32.instance) {
        @Override
    ...
    private static final Lazy<CastOperation> INT8_TO_FLOAT64 = new Lazy<>(() -> new CastOperation(instance, SFloat.instance) {
        @Override
        public void apply(MethodVisitor visitor) {
    ...
    private static final Lazy<CastOperation> INT8_TO_INT64 = new Lazy<>(() -> new CastOperation(instance, SInt64.instance) {
        @Override
        public void apply(MethodVisitor visitor) {
    ...
    private static final Lazy<CastOperation> INT8_TO_INT32 = new Lazy<>(() -> new CastOperation(instance, SInt.instance) {
        @Override
        public void apply(MethodVisitor visitor) {}
    });

    private static final Lazy<CastOperation> INT8_TO_INT16 = new Lazy<>(() -> new CastOperation(instance, SInt16.instance) {
        @Override
        public void apply(MethodVisitor visitor) {}
    });

    private static final Lazy<CastOperation> INT8_TO_BOXED = new Lazy<>(() -> new CastOperation(instance, instance.boxed) {
        @Override
        public void apply(MethodVisitor visitor) {
