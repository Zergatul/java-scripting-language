...
public abstract class ParserTreeVisitor {
    ...
    public void explicitVisit(BaseExpressionNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(CatchClauseNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(CatchDeclarationNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(ClassFieldNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(ClassMethodNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(ClassNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(ExtensionNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(ExpressionUnitNode node) {
        visit(node);
        node.acceptChildren(this);
    }

    public void explicitVisit(FinallyClauseNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void explicitVisit(ThisExpressionNode node) {
        visit(node);
        node.acceptChildren(this);
    }
    ...
    public void visit(CatchDeclarationNode node) {}
    ...
    public void visit(ExtensionNode node) {}
    public void visit(ExpressionUnitNode node) {}
    public void visit(FinallyClauseNode node) {}
